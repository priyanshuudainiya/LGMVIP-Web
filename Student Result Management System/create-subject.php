...
---------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="card">
            <form method="post">
                    ...
                    <input type="text" name="subject_code" class="form-control" placeholder="Please enter subject code..." required><br>
                    <label>Subject Name: </label>
                    <input type="text" name="subject_name" class="form-control" placeholder="Please enter subject name..." required><br>
                    <button class="btn btn-success" name="add_subject" type="submit">ADD</button>
            </form>
        </div>
...
if(isset($_POST['add_subject'])){
    ...
    $subject_created_date = date("d-m-Y");

    $insertquery = "INSERT INTO subject (subject_code,subject_name,subject_created_date) VALUES ('$subject_code','$subject_name','$subject_created_date')";
