...
<head>
    ...
    <title> Manage Students Classes </title>
</head>
<body>
                ...
                <table id="example" class="table table-striped" style="width:100%; text-align: center;">
                    ...
                    while($result = mysqli_fetch_array($query)){ ?>
                        <tr>
                            ...
                            <td><a href="edit-class.php?id=<?php echo $result['id']?>"><button class="btn btn-warning"><i class='bx bx-edit'></i></button></a></td>
                            <td><a href="delete-class.php?id=<?php echo $result[0]?>"><button class="btn btn-danger"><i class='bx bx-trash'></i></button></a></td>
                        </tr>
                        <?php  }  ?>
                    </tbody>
                </table>
