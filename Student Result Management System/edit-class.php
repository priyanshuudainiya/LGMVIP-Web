...
---------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="card">
            ...
            <form method="post">
                    ...
                    <input type="text" name="class_name" class="form-control" value="<?php echo $result['class_name']; ?>" placeholder="Please enter the class name..." required><br>
                    <label>Class Name In Numeric:</label>
                    <input type="text" name="class_numeric" class="form-control" value="<?php echo $result['class_code']; ?>" placeholder="Please enter the class name in numeric..." required><br>
                    <button class="btn btn-info" name="update_class" type="submit">Update</button>
            </form>
        </div>
    </section>
...
if(isset($_POST['update_class'])){
    ...
    $updatequery = "UPDATE class set class_name='$class_name', class_code='$class_numeric' WHERE id='$id'";
