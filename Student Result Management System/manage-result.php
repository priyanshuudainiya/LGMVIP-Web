...
---------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="card-body">
                <table id="example" class="table table-striped" style="width:100%; text-align: center;">
                    ...
                    // Select Class Data 
                    $num = 1;
                    $selectquery = "SELECT * FROM result INNER JOIN class ON class.id = result.class_id INNER JOIN student ON student.id = result.student_id ";
                    ...
                    while($result = mysqli_fetch_array($query)){ ?>
                        <tr>
                            ...
                            <td><a href="delete-result.php?id=<?php echo $result[0]?>"><button class="btn btn-danger"><i class='bx bx-trash'></i></button></a></td>
                        </tr>
                        <?php  }  ?>
                    </tbody>
                </table>
